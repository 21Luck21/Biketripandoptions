...
export function Bike({ size = 42 }: IconProps) {
  return (
...
export function Lake({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Forest({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Palace({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Star({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Factory({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Cottage({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Compass({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Train({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Lighthouse({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Cliff({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function Beach({ size = 42 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" {...SK}>
...
export function ArrowDown({ size = 24 }: IconProps) {
  return (
